...
export default function DashboardSidebar({ navItems, portalLabel }: DashboardSidebarProps) {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="px-1 mb-4">
        <span className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">{portalLabel}</span>
      </div>

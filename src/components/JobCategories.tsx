...
const JobCategories = () => {
  ...
  const categories = [
    { icon: constructionIcon, title: "Construction", jobs: "12,847", avgSalary: "₹2,50,000/month", description: "Infrastructure projects, residential and commercial building", demand: "High", countries: ["Japan", "Germany", "UAE", "Saudi Arabia", "Qatar"] },
    { icon: electricianIcon, title: "Electrical", jobs: "8,234", avgSalary: "₹3,00,000/month", description: "Industrial electrical work, renewable energy projects", demand: "Very High", countries: ["Norway", "Australia", "Canada", "Singapore", "UK"] },
    { icon: welderIcon, title: "Welding", jobs: "6,521", avgSalary: "₹3,20,000/month", description: "Pipeline, shipbuilding, and heavy industry welding", demand: "High", countries: ["Qatar", "South Korea", "Kuwait", "Bahrain", "Malaysia"] },
    { icon: "🔧", title: "Plumbing", jobs: "5,432", avgSalary: "₹2,30,000/month", description: "Residential and commercial plumbing systems", demand: "Medium", countries: ["UK", "Ireland", "New Zealand", "Australia", "Canada"] },
    { icon: "🚚", title: "Delivery & Logistics", jobs: "15,678", avgSalary: "₹1,90,000/month", description: "Package delivery, freight, and supply chain", demand: "Very High", countries: ["Netherlands", "Belgium", "Denmark", "Germany", "France"] },
    { icon: "🏭", title: "Manufacturing", jobs: "9,876", avgSalary: "₹2,40,000/month", description: "Assembly line, quality control, machine operation", demand: "High", countries: ["Czech Republic", "Poland", "Malaysia", "Vietnam", "Thailand"] }
  ];

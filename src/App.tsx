          ...
          <AuthProvider>
            ...
            <PageTransition>
              <Routes>
                ...
                <Route path="/worker/applications/:applicationId" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerApplicationDetail /></ProtectedRoute>} />
                <Route path="/worker/application-tracking" element={<ProtectedRoute allowedRoles={["worker"]}><ApplicationTracking /></ProtectedRoute>} />
                <Route path="/worker/messaging" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerMessaging /></ProtectedRoute>} />
                <Route path="/worker/training" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerTraining /></ProtectedRoute>} />
                <Route path="/worker/contracts" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerContracts /></ProtectedRoute>} />
                <Route path="/worker/travel" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerTravelStatus /></ProtectedRoute>} />
                <Route path="/worker/insurance" element={<ProtectedRoute allowedRoles={["worker"]}><WorkerInsurance /></ProtectedRoute>} />
                ...
                <Route path="/employer/escrow" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerEscrow /></ProtectedRoute>} />
                <Route path="/employer/compliance" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerCompliance /></ProtectedRoute>} />
                <Route path="/employer/messaging" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerMessaging /></ProtectedRoute>} />
                <Route path="/employer/saved-searches" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerSavedSearches /></ProtectedRoute>} />
                ...
                <Route path="/employer/applications/:applicationId" element={<ProtectedRoute allowedRoles={["employer"]}><ApplicationDetail /></ProtectedRoute>} />
                <Route path="/employer/shortlist" element={<ProtectedRoute allowedRoles={["employer"]}><WorkerShortlist /></ProtectedRoute>} />
                <Route path="/employer/formalities" element={<ProtectedRoute allowedRoles={["employer"]}><ManageFormalities /></ProtectedRoute>} />
                <Route path="/employer/payments" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerPayments /></ProtectedRoute>} />
                <Route path="/employer/contracts" element={<ProtectedRoute allowedRoles={["employer"]}><ContractManagement /></ProtectedRoute>} />
                <Route path="/employer/contract-history" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerContractHistory /></ProtectedRoute>} />
                <Route path="/employer/reports" element={<ProtectedRoute allowedRoles={["employer"]}><EmployerReports /></ProtectedRoute>} />

                {/* Admin */}
                <Route path="/admin/dashboard" element={<ProtectedRoute allowedRoles={["admin"]}><AdminDashboard /></ProtectedRoute>} />
                <Route path="/admin/users" element={<ProtectedRoute allowedRoles={["admin"]}><UserManagement /></ProtectedRoute>} />
                <Route path="/admin/job-verification" element={<ProtectedRoute allowedRoles={["admin"]}><JobVerification /></ProtectedRoute>} />
                <Route path="/admin/edit-job/:jobId" element={<ProtectedRoute allowedRoles={["admin"]}><EditJob /></ProtectedRoute>} />
                <Route path="/admin/document-verification" element={<ProtectedRoute allowedRoles={["admin"]}><DocumentVerification /></ProtectedRoute>} />
                <Route path="/admin/id-verification" element={<ProtectedRoute allowedRoles={["admin"]}><IDVerification /></ProtectedRoute>} />
                <Route path="/admin/ecr-management" element={<ProtectedRoute allowedRoles={["admin"]}><ECRManagement /></ProtectedRoute>} />
                <Route path="/admin/compliance" element={<ProtectedRoute allowedRoles={["admin"]}><ComplianceCheck /></ProtectedRoute>} />

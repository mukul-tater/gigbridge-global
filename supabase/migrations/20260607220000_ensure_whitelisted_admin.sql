-- Assign admin role for whitelisted emails (signup trigger + login backfill).
...
-- Callable after admin login/register to backfill role if trigger was missing.
...
-- Backfill existing whitelisted accounts (e.g. admin@safeworkglobal.demo).
INSERT INTO public.user_roles (user_id, role)
